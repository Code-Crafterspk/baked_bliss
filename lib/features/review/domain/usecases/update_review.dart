...
class UpdateReviewUseCase implements UseCase<void, ReviewModel> {
  final ReviewRepository reviewRepository;

  UpdateReviewUseCase(this.reviewRepository);

  @override
  Future<Either<Failure, void>> call(ReviewModel params) async {
    return await reviewRepository.updateReview(params);
  }
}
